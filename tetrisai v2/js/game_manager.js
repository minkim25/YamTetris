function GameManager(){
    ...
    function startTurn(){
        ...
        if(isAiActive){
            ...
            outputGrid = new Array(grid.rows * grid.columns);
            i = 0;
    ...
    function appendToBlob(rows, blob=null){
        ...
        if(blob == null){
            ...
            blob = new Blob([blob,[rows + '\n']], {type: 'text/csv;charset=utf-8;'});
        }
        return blob;
    }

    function exportToCsv(filename, blob) {
